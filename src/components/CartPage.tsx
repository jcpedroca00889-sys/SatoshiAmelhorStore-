        ...
        {isCartOpen && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-2xl mx-4 my-8 sm:my-16 bg-surface/95 backdrop-blur-xl rounded-3xl border border-border/40 shadow-2xl overflow-hidden"
            >
              {/* Header */}
              ...
              <div className="p-5 sm:p-6">
                {items.length === 0 ? (
                  <div className="flex flex-col items-center gap-4 py-12 sm:py-16">
                    <div className="w-20 h-20 rounded-2xl bg-surface-3/50 flex items-center justify-center">
                      <ShoppingBag size={36} className="text-text-tertiary/40" />
                    </div>
                    ...
                    <div className="space-y-3 max-h-[50vh] overflow-y-auto pr-1 -mr-1">
                      {items.map((item, i) => (
                        <motion.div
                          ...
                          className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-2xl bg-surface-3/20 border border-border/30 group hover:border-orange-500/20 transition-all"
                        >
                          {/* Image */}
                          <div
                      ...
                      <div className="space-y-2 text-xs sm:text-sm">
                        ...
                        <div className="flex items-center justify-between text-text-tertiary">
                          <span className="flex items-center gap-1.5">
                            <Shield size={12} /> Taxa de serviço
                          </span>
                        ...
                        <div className="flex items-center justify-between text-text-tertiary">
                          ...
                          <span className={freteGratis ? "text-green-400" : ""}>
